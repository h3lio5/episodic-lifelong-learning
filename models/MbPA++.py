...
class MbPAplusplus(object):
    ...
    def infer(self,content_batch):
        ...
        for content in content_batch:
            ...
            for epoch in range(self.L):
                ...
                optimizer.zero_grad()
                likelihood_loss,logits = new_model(k_content,attention_mask=k_attn_masks,labels=k_labels)
    ...
    def _get_neighbour_keys(self,key):
        ...
        if self.mode == 'nearest':
            ...
            K_neighbour_keys = all_keys[np.argpartition(all_keys,-k)[-k:]]
    ...
    def push(self,examples):
        ...
        with torch.no_grad():
            last_hidden_states,_ = self.key_enc(contents,attention_mask=attn_masks)
